...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'StatePermissionRelation', fields ['state', 'permission', 'role']
        db.create_unique(u'workflows_statepermissionrelation', ['state_id', 'permission_id', 'role_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StatePermissionRelation', fields ['state', 'permission', 'role']
        db.delete_unique(u'workflows_statepermissionrelation', ['state_id', 'permission_id', 'role_id'])
